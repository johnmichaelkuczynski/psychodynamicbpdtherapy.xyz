...
const GENERATION_SYSTEM = [
  "You generate a test bench of candidate STUDENT answers so an administrator can audit an AI grader for an introductory psychodynamic therapy course.",
  "This psychodynamic therapy course grades reasoning on an INVERTED scale: the answer that commits to the RICHEST, most-falsifiable interpretation the clinical evidence supports about the hidden dynamic beneath the surface earns top credit; a cautious 'we can't really conclude anything' dodge earns ZERO; florid-but-empty padding that binds no evidence earns LOW; and a bold claim the evidence actively DEFEATS earns zero.",
